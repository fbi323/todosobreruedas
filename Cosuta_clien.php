...
echo "<th>DOCUMENTO</th><th>NOMBRE</th><th>APELLIDO</th><th>EMAIL</th><th>TELEFONO</th><th>DIRECCION</th><th>MUNICIPIO</th>  <th>DEPARTAMENTO</th><th>CIUDAD</th>";
echo "<tr><td><br></td></tr>";
$i=1;
...
{   
    ...
    echo "<td>".$row[ "apelli_cli"  ]."</td>";
    echo "<td>".$row[ "email"       ]."</td>";
    echo "<td>".$row[ "tel_cli"     ]."</td>";
    echo "<td>".$row[ "direc_cli"   ]."</td>";
    echo "<td>".$row[ "ciud_cli"    ]."</td>";
